...
<div id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( $classes ); ?> alignfull <?php if ( get_field( 'top_and_bottom_margin' ) == 1 ) { ?>has-top-bottom-margin<?php } ?> <?php if ( $wd_color_text_class ) { ?>has-<?php echo $wd_color_text_class; ?>-color<?php } ?>  <?php if ( $wd_color_class ) { ?>has-<?php echo $wd_color_class; ?>-background-color<?php } ?>">
    <div class="gridcontainer <?php the_field( 'column_layout' ); ?> <?php if ( get_field( 'top_and_bottom_padding' ) == 1 ) : ?>has-top-bottom-padding<?php endif; ?> <?php if ( get_field( 'use_column_gap' ) == 1 ) { ?>has-column-gap<?php }else{ ?>has-no-column-gap<?php } ?> <?php echo esc_attr( $classes_align ); ?>  <?php if ( get_field( 'top_line' ) == 1 ) : ?>has-top-line<?php endif; ?> <?php if ( get_field( 'column_line' ) == 1 ) : ?>has-column-line<?php endif; ?>">
    ...
    <?php if ( have_rows( 'left_column' ) ): ?>
        ...
        <?php if( get_field( 'headline_left' ) ) : ?>
            <header><h2><?php the_field( 'headline_left' ); ?></h2></header>
        <?php endif; ?>
        <?php while ( have_rows( 'left_column' ) ) : the_row(); ?>
            ...
            <!-- Image hotspot -->
            <?php elseif ( get_row_layout() == 'image_hotspots' ) : ?>
                <?php get_template_part('/lib/template-parts/blocks/modules/module', 'image_hotspot'); ?>
            
            <?php elseif ( get_row_layout() == 'timelines' ) : ?>
            <!-- Timeline -->
                <?php get_template_part('/lib/template-parts/blocks/modules/module', 'timeline'); ?>
    ...
    <?php if ( have_rows( 'Right_column' ) ): ?>
        ...
        <?php if( get_field( 'headline_right' ) ) : ?>
            <header><h2><?php the_field( 'headline_right' ); ?></h2></header>
        <?php endif; ?>
